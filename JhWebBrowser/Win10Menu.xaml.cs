...
{
    /// <summary>
    /// Win10Menu.xaml 的交互逻辑
    /// </summary>
    //public partial class Win10Menu : Window,ICommand
    public partial class Win10Menu : Window
    {
        /// <summary>
        /// 定义NotifyIcon
        /// </summary>
        ...
        public Win10Menu()
        {
            InitializeComponent();
            icon();
            search_Selected(null,null);//调用music.163
...
说明：Hello，我的小可爱 我是你的管家";//最小化到托盘时，鼠标点击时显示的文本
        ...
        private void mid_Click(object sender, RoutedEventArgs e)
        {
            ...
            WindowsState = 1;
            if (styleMid == null)
                styleMid = FindResource("windowBaseStyle") as Style;
            this.Style = styleMid;
        ...
        private void max_Click(object sender, RoutedEventArgs e)
        {
            ...
            WindowsState = 2;
            if (style == null)
                style = FindResource("windowMaxBaseStyle") as Style;
            this.Style = style;
